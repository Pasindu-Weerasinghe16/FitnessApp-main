...
class _YourGoalScreenState extends State<YourGoalScreen> {
  ...
  // Removed explicit CarouselController (not required for current usage and
  // avoids version-specific API issues with carousel_slider v5).
            ...
            Center(
              child: carousel.CarouselSlider(
                items: pageList
                    ...
                    .toList(),
                // No controller needed for current interactions
